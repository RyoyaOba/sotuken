...
# データ読み込みと前処理
def load_and_preprocess_data(directory, num_samples=100):
    data = []
    labels = []
...
def cluster_and_output(data_directory, output_directory):
    # データ読み込みと前処理
    data, labels = load_and_preprocess_data(data_directory, num_samples=100)
    ...
    # KMeansクラスタリングを実行
    num_clusters = determine_num_clusters(distance_matrix)
